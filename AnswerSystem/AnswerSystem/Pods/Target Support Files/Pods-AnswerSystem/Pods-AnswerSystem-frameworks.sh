...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MMBaseComponents/MMBaseComponents.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MMBusinessComponents/MMBusinessComponents.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MMToolHelper/MMToolHelper.framework"
