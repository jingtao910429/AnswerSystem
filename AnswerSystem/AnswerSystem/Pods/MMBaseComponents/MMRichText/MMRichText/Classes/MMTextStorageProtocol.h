...
typedef enum : NSUInteger {
    MMDrawAlignmentTop,     // 底部齐平 向上伸展
    MMDrawAlignmentCenter,  // 中心齐平
    MMDrawAlignmentBottom,  // 顶部齐平 向下伸展
} MMDrawAlignment;

extern NSString *const kMMTextRunAttributedName;

@protocol MMTextStorageProtocol <NSObject>
@required
...
@protocol MMAppendTextStorageProtocol <MMTextStorageProtocol>
...
@protocol MMLinkStorageProtocol <MMAppendTextStorageProtocol>

@property (nonatomic, strong) UIColor   *textColor;     // 文本颜色

@end

@protocol MMDrawStorageProtocol <MMAppendTextStorageProtocol>
...
@protocol MMViewStorageProtocol <NSObject>
